...
class PostQuerySet(models.QuerySet):
    ...
    def fetch_with_comments_count(self):
        """ 
        Добавляет число комментариев с помощью отдельного запроса,
        тем самым увеличивает скорость выполнения если в исходном запросе
        уже использовали annotate по другому полю, т.к. избавляется
        от множественного задвоения данных
        """
        posts = list(self)
